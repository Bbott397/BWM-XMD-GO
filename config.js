...
class HybridConfigManager {
    ...
    createDefaultConfig() {
        const defaultConfig = {
            ...
            settings: {
                AUDIO_CHATBOT: process.env.AUDIO_CHATBOT || 'yes',
                ...
                ANTIDELETE_SENT_INBOX: process.env.ANTIDELETE_SENT_INBOX || 'no',
...
module.exports = {
    hybridConfig,
    session: process.env.SESSION_ID || 'Grandpacyril_gj16u',
    sessionId: hybridConfig.getSessionId(),
    PREFIX: process.env.PREFIX || ".",
    GURL: 'https://whatsapp.com/channel/0029VaZuGSxEawdxZK9CzM0Y',
    OWNER_NAME: process.env.OWNER_NAME || "Grandpa Cyril",
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2349114238804",
    BOT: process.env.BOT_NAME || 'OSAKPOLOR-ASSISTANT',
    ...
    get CHATBOT() { return hybridConfig.getSetting('CHATBOT', 'yes'); },
    get CHATBOT1() { return hybridConfig.getSetting('AUDIO_CHATBOT', 'yes'); },
    ...
    get ANTIDELETE2() { return hybridConfig.getSetting('ANTIDELETE_SENT_INBOX', 'no'); },
    get GOODBYE_MESSAGE() { return hybridConfig.getSetting('GOODBYE_MESSAGE', 'no'); },
    get ANTICALL() { return hybridConfig.getSetting('AUTO_REJECT_CALL', 'yes'); },
